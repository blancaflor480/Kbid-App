...
import com.example.myapplication.ui.content.ImageFragment;
import com.example.myapplication.ui.content.ModelContent;
...
public class AdapterContent extends RecyclerView.Adapter<AdapterContent.MyHolder> {

    Context context;
    List<ModelContent> list;
     ...
     private void showPopupMenu(View view, int position) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                ModelContent content = list.get(position);
...
*/
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            date = itemView.findViewById(R.id.datetimep);
