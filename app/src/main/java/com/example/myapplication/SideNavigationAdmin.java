...
public class SideNavigationAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_user, R.id.nav_admin, R.id.nav_stories, R.id.nav_video, R.id.nav_devotional, R.id.nav_games, R.id.nav_record, R.id.nav_feedback, R.id.nav_setting)
